...
На Centos пришлось изменить настройку: sysctl -w vm.max_map_count=262144

#sysctl -n vm.max_map_count
262144

https://prnt.sc/zvodn2



- > скриншот интерфейса kibana

https://prnt.sc/zvol0e



> docker-compose немного изменил
...
> logstash.conf изменил, с пустым фильтом не отрабатывало..
>
...
> вид в kibana (Discover) :

https://prnt.sc/103sqpy
